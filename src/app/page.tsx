...
export default function Home() {
  return (
    <>
      ...
      <section id="section-b" className="px-4 py-28">
              ...
              <div className="">
                <div className="p-8 pb-0">
                  ...
                  <p className="text-base text-gray-400">
                    ...
                    Accusantium illo culpa totam, corporis sed blanditiis?
                  </p>
                </div>
                <Marquee className="mt-4 pb-8 group-hover/spotlight:[--animation-play-state:paused]">
                  <div className="flex items-center justify-center rounded-full border border-gray-800 bg-gray-950/100 p-3 transition-colors group-hover/spotlight:bg-gray-950/25">
                    <svg
                  ...
                  <div className="flex items-center justify-center rounded-full border border-gray-800 bg-gray-950/100 p-3 transition-colors group-hover/spotlight:bg-gray-950/25">
                    ...
                    >
                      <path
                        fill="#3178C6"
                        d="M128 0c70.692 0 128 57.308 128 128c0 70.692-57.308 128-128 128C57.308 256 0 198.692 0 128C0 57.308 57.308 0 128 0Z"
                      ></path>
                      <path
                        fill="#FFF"
          ...
          <div className="row-span-2">
            <SpotlightCard>
              <div className="flex h-full flex-col p-8">
                ...
                <h3 className="mb-2 mt-auto font-mono text-6xl font-semibold text-primary-400 transition-colors group-hover/spotlight:text-white">
                  €50/h
                </h3>
              </div>
            </SpotlightCard>
              ...
              <div className="mt-4 flex items-center space-x-2">
                <div className="flex items-center justify-center rounded-full border border-gray-800 bg-gray-950/100 p-3 transition-colors group-hover/spotlight:bg-gray-950/25">
                  ...
                  >
                    ...
                    <path
                      fillOpacity=".2"
                      d="m140.517 154.896l-39.658 39.601l15.267 15.182z"
                    ></path>
                    <path
                      fill="#53B9FF"
                    ...
                    <path
                      fill="#119EFF"
                      d="m115.36 100.987l39.659-39.602L93.917.313L54.365 39.914z"
                    ></path>
                    <path
                      fillOpacity=".2"
                      d="m115.359 100.985l39.659-39.601l-15.271-15.186z"
                    ></path>
                  </svg>
                </div>
                <div className="flex items-center justify-center rounded-full border border-gray-800 bg-gray-950/100 p-3 transition-colors group-hover/spotlight:bg-gray-950/25">
                  ...
                  >
                    ...
                    <path
                      fill="#24C8DB"
                      d="M47.913 95.577a104.766 104.766 0 0 1 36.419-14.842a73.46 73.46 0 0 0-4.116 33.3c-29.847 10.619-49.549 39.148-48.906 70.822c.642 31.673 21.484 59.38 51.738 68.78c30.253 9.399 63.127-1.62 81.604-27.352a122.227 122.227 0 0 0 40.16-11.6c-13.736 44.169-54.812 74.1-101.064 73.645c-46.252-.453-86.733-31.184-99.602-75.612c-12.87-44.427 4.92-92.037 43.768-117.141Zm155.528 100.026l-.5.25l.5-.25Z"
                    ></path>
                  </svg>
                </div>
              </div>
